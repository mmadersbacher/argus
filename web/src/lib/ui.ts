...
export const bandStyles: Record<RiskBand, BandStyle> = {
  critical: { label: "Critical", text: "text-crit", bg: "bg-crit/10", ring: "ring-crit/30", bar: "bg-crit" },
  high: { label: "High", text: "text-high", bg: "bg-high/10", ring: "ring-high/30", bar: "bg-high" },
  medium: { label: "Medium", text: "text-med", bg: "bg-med/10", ring: "ring-med/30", bar: "bg-med" },
  low: { label: "Low", text: "text-low", bg: "bg-low/10", ring: "ring-low/30", bar: "bg-low" },
  info: { label: "Info", text: "text-info", bg: "bg-info/10", ring: "ring-info/30", bar: "bg-info" },
};
